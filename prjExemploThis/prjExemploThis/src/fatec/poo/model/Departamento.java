...
public class Departamento {
    ...
    public void addFuncionario(Funcionario f){
        funcionarios.add(f);//Departamneto ---> Funcionario (Horista, Mensalista, Comissionado)
        f.setDepartamento(this);//Funcionario (Horista, Mensalista, Comissionado) ---> Departamento
    }
